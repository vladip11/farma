...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-08-2020 a las 06:45:59
...
INSERT INTO `articulo` (`idarticulo`, `idcategoria`, `codigo`, `nombre`, `stock`, `descripcion`, `imagen`, `ubicacion`, `condicion`) VALUES
(14, 13, '450mg', 'aspirina', 35, 'analgesico', '2020-08-20', 'estaporahi', 1);
...
INSERT INTO `persona` (`idpersona`, `tipo_persona`, `nombre`, `tipo_documento`, `num_documento`, `direccion`, `telefono`, `correo`) VALUES
(8, 'Cliente', 'carlos', 'DNI', '1025874', 'junin', '78541236', 'es@gmail.com');
...
(4, 8, 18, 'Boleta', '45', '21', '2020-08-18', '13.50', '0.00', 'Anulado'),
(5, 8, 18, 'Boleta', '45', '21', '2020-08-18', '0.00', '0.00', 'Aceptado'),
(6, 8, 18, 'Boleta', '45', '12', '2020-08-18', '1.00', '29.00', 'Aceptado');
